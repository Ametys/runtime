...
/**
 * This class represents a model for a {@link UserDirectory}
 */
public interface UserDirectoryModel
{
     ...
     * @return the user directory class
     */
    public Class<UserDirectory> getUserDirectoryClass();
    
    /**
     * Get the additional configuration for the implementation of {@link UserDirectory}

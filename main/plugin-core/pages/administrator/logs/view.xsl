            ...
            <body>
                ...
                <script>
                    ...
                    var handle2 = sp.addCategory("<i18n:text i18n:key="PLUGINS_CORE_ADMINISTRATOR_LOGS_HANDLE"/>");
                        ...
                        handle2.addLink("<i18n:text i18n:key="PLUGINS_CORE_ADMINISTRATOR_LOGS_HANDLE_LOGLEVEL_TO_WARNING"/>", "<xsl:value-of select="$resourcesPath"/>/img/administrator/logs/loglevel_warning.gif", goWarning);

                                                ...
                                                <xsl:for-each select="*">
                                                    ...
                                                    <tr>
                                                        <td class="label">
                                                            ...
                                                            <i18n:text i18n:catalogue="plugin.{@plugin}" i18n:key="{label}"/>
                                                            <img src="{$resourcesPath}/img/administrator/config/help.gif" i18n:attr="title" title="plugin.{@plugin}:{description}"/>
                                                        </td>

...
("<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_0"/>",
 "<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_1"/>",
 "<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_2"/>",
 "<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_3"/>",
 "<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_4"/>",
 "<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_5"/>",
 "<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_6"/>",
 "<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_7"/>",
 "<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_8"/>",
 "<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_9"/>",
 "<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_10"/>",
 "<i18n:text i18n:key="PLUGINS_CORE_WIDGET_DATE_SMONTH_11"/>");

 ...
 * @private
 */
Ext.define('Ametys.plugins.core.administration.system.SystemActions', {
	singleton: true,
	...
	setAnnouncementAvailable: function(controller)
	{
		...
		Ametys.data.ServerComm.callMethod({
			role: "org.ametys.runtime.plugins.core.administrator.system.SystemHelper",
	...
	deleteMessage: function (controller)
	{
		...
		if (target != null)
		{
			Ametys.Msg.confirm ("<i18n:text i18n:key='PLUGINS_CORE_ADMINISTRATOR_SYSTEM_ANNOUNCEMENT_DELETE_LABEL'/>", 
	...
	_delayedInitialize: function ()
	{
		...
		this._form = Ext.create('Ext.form.Panel', {
			...
			items : [ {
							...
							allowBlank: false,
							regex: /^[a-z]{2}$/,
							regexText: "<i18n:text i18n:key='PLUGINS_CORE_ADMINISTRATOR_SYSTEM_ANNOUNCEMENT_DIALOG_ERROR_LANG'/>"
						},
						{
							xtype: 'textarea',
		...
		this._box = Ext.create('Ametys.window.DialogBox', {
			...
			icon: Ametys.getPluginResourcesPrefix('core') + '/img/administrator/system/announcement_16.png',
	...
	_editAnnouncementCb: function(response, args)
	{
		if (response['already-exists'])
		{
			...
			Ametys.Msg.confirm ("<i18n:text i18n:key='PLUGINS_CORE_ADMINISTRATOR_SYSTEM_CONFIRM_DIALOG_TITLE'/>", 
							    "<i18n:text i18n:key='PLUGINS_CORE_ADMINISTRATOR_SYSTEM_CONFIRM_DIALOG_TEXT'/>", 

 ...
 * @private
 */
Ext.define("Ametys.plugins.core.system.requesttracker.RequestTrackerTool",
	{
		...
		createPanel: function()
		{
			this.store = Ext.create("Ext.data.ArrayStore",{
				...
				model: "Ametys.plugins.core.system.requesttracker.RequestTrackerTool.RequestEntry",
				autoDestroy: true,
				autoSync: true,
				proxy: { type: 'memory' }
		    });
			...
			this.grid = Ext.create("Ext.grid.Panel", { 
				...
				autoScroll: true,
			    columns: [
			        {stateId: 'grid-id', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_COL_ID'/>", width: 40, sortable: true, dataIndex: 'id', hideable: false},
			        {stateId: 'grid-type', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_COL_TYPE'/>", width: 70, sortable: true, dataIndex: 'type'},
			        {stateId: 'grid-date', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_COL_DATE'/>", width: 130, sortable: true, renderer: Ext.util.Format.dateRenderer(Ext.Date.patterns.ShortDateTime), dataIndex: 'date'},
			        {stateId: 'grid-duration', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_COL_DURATION'/>", width: 50, sortable: true, dataIndex: 'duration'},
			        {stateId: 'grid-size', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_COL_SIZE'/>", width: 60, sortable: true, dataIndex: 'size'},
			        {stateId: 'grid-return', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_COL_RETURN'/>", width: 50, sortable: true, dataIndex: 'return'}
			    ],
			...
			this.msgStore = Ext.create("Ext.data.ArrayStore",{
				sorters: [{property: 'id', direction:'DESC'}],
				model: "Ametys.plugins.core.system.requesttracker.RequestTrackerTool.MessageEntry",
				autoDestroy: true,
				autoSync: true,
				proxy: { type: 'memory' }
		    });
			...
			this.msgGrid = Ext.create("Ext.grid.Panel", { 
				...
				autoScroll: true,
			    columns: [
			        {stateId: 'msgrid-id', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_ID'/>", width: 40, sortable: true, dataIndex: 'id', hideable: false},
			        {stateId: 'msgrid-readabletype', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_READABLE_TYPE'/>", width: 70, sortable: true, dataIndex: 'readableCallType', renderer: Ext.bind(this._renderCallType, this)},
			        {stateId: 'msgrid-readablevalue', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_READABLE_VALUE'/>", width: 250, sortable: true, dataIndex: 'readableCallValue'},
			        {stateId: 'msgrid-plugin', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_PLUGIN'/>", width: 70, sortable: true, hidden: true, dataIndex: 'plugin'},
			        {stateId: 'msgrid-workspace', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_WORKSPACE'/>", width: 70, sortable: true, hidden: true, dataIndex: 'workspace'},
			        {stateId: 'msgrid-url', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_URL'/>", width: 180, sortable: true, hidden: true, dataIndex: 'url'},
			        {stateId: 'msgrid-ccrole', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_CCROLE'/>", width: 180, sortable: true, hidden: true, dataIndex: 'clientCallRole'},
			        {stateId: 'msgrid-ccid', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_CCID'/>", width: 180, sortable: true, hidden: true, dataIndex: 'clientCallId'},
			        {stateId: 'msgrid-ccmethod', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_CCMETHOD'/>", width: 180, sortable: true, hidden: true, dataIndex: 'clientCallMethod'},
			        {stateId: 'msgrid-priority', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_PRIORITY'/>", width: 60, sortable: true, dataIndex: 'priority'},
			        {stateId: 'msgrid-type', header: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_TYPE'/>", width: 50, sortable: true, dataIndex: 'type'}
			    ],
			...
			this.rightPanel = Ext.create("Ext.Panel", {
				...
				autoScroll: true,
				cls: 'message-details',
				defaultHtml: "<i18n:text i18n:key='PLUGINS_CORE_TOOLS_REQUESTS_TRACKER_MESSAGE'/>",
				html: "<i18n:text i18n:key='PLUGINS_CORE_TOOLS_REQUESTS_TRACKER_MESSAGE'/>"
			});
			
			this._messageTpl = new Ext.Template(
					"<b><i18n:text i18n:key='REQUESTSTRACKER_TOOL_DISPLAYMESSAGE_URL'/></b> : ",
					"{url}<br/><br/>",
					"<b><i18n:text i18n:key='REQUESTSTRACKER_TOOL_DISPLAYMESSAGE_PARAMETERS'/></b> : ",
					"<code class='resquest-tracker'>{parameters}</code><br/>",
					"<b><i18n:text i18n:key='REQUESTSTRACKER_TOOL_DISPLAYMESSAGE_RESPONSE'/></b> : ",
		...
		_renderCallType: function(value, metaData, record, rowIndex, colIndex, store, view)
		{
			...
			{
				return "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_READABLE_VAL2'/>";
			}
		},
		...
		_onSelectRequest: function (selModel, records, eOpts)
		{
			...
			{
				if (message && message.url == "client-call" && message.plugin == "core")
				{
					return {
			...
			for (var i = 0; i < messages.length; i++)
			{
				...
				if (message.priority != null)
				{
					...
					{
						case Ametys.data.ServerComm.PRIORITY_MAJOR: priority = "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_PRIORITY_MAJOR'/>"; break;
						case Ametys.data.ServerComm.PRIORITY_NORMAL: priority = "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_PRIORITY_NORMAL'/>"; break;
						case Ametys.data.ServerComm.PRIORITY_MINOR: priority = "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_PRIORITY_MINOR'/>"; break;
						case Ametys.data.ServerComm.PRIORITY_SYNCHRONOUS: priority = "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_PRIORITY_SYNCHRONOUS'/>"; break;
						case Ametys.data.ServerComm.PRIORITY_LONG_REQUEST: priority = "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_PRIORITY_LONG_REQUEST'/>"; break;
						default: priority = message.priority;
					}
					
					var r = Ext.create("Ametys.plugins.core.system.requesttracker.RequestTrackerTool.MessageEntry", {
						id: i,
				...
				else
				{
					var r = Ext.create("Ametys.plugins.core.system.requesttracker.RequestTrackerTool.MessageEntry", {
						...
						workspace: message.workspace,
						url: this._removeGetParameters(message.url),
						priority: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_MESSAGE_COL_PRIORITY_SYNCHRONOUS'/>",
						type: message.responseType,
						clientCallRole: clientCallInfo.role,
						clientCallId: clientCallInfo.id,
						clientCallMethod: clientCallInfo.method,
		...
		onRequestDeparture: function (sendOptions)
		{
			...
			try
			{
				...
				var record = Ext.create("Ametys.plugins.core.system.requesttracker.RequestTrackerTool.RequestEntry", {
					id: id,
					type: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_COL_TYPE_ASYNC'/>",
					date: new Date(),
					duration: "...",
					"return": "...",
		...
		onRequestArrival: function (sendOptions, responseType, response)
		{
			...
			try
			{
				...
				{
					case 0:
						record.set("return", "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_COL_RETURN_OK'/>"); 
						break;
					case 1:
						record.set("return", "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_COL_RETURN_CANCELED'/>");
						break;
					case 2:
						record.set("return", "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_COL_RETURN_FAILURE'/>");
						break;
				}
				record.commit();
			}
		...
		onSyncRequestDeparture: function (message)
		{
			...
			try
			{
				...
				window.setTimeout(function() {
					var record = Ext.create("Ametys.plugins.core.system.requesttracker.RequestTrackerTool.RequestEntry", {
						id: id,
						type: "<i18n:text i18n:key='REQUESTSTRACKER_TOOL_COL_TYPE_SYNC'/>",
						date: new Date(),
						duration: "...",
						"return": "...",
						size: 1,

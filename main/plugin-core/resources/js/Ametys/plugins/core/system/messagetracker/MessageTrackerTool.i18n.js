 ...
 * @private
 */
Ext.define("Ametys.plugins.core.system.messagetracker.MessageTrackerTool",
	{
		...
		createPanel: function()
		{
			this.store = Ext.create("Ext.data.ArrayStore",{
				...
				model: "Ametys.plugins.core.system.messagetracker.MessageTrackerTool.MessageEntry"
		    });
			...
			this.grid = Ext.create("Ext.grid.Panel", { 
				...
				autoScroll: true,
			    columns: [
			    	{stateId: 'grid-id', header: "<i18n:text i18n:key='PLUGINS_CORE_TOOLS_MESSAGES_TRACKER_TOOL_COL_ID'/>", width: 40, sortable: true, dataIndex: 'id', hideable: false},
			        {stateId: 'grid-creationdate', header: "<i18n:text i18n:key='PLUGINS_CORE_TOOLS_MESSAGES_TRACKER_TOOL_COL_CREATIONDATE'/>", width: 120, sortable: true, renderer: Ext.util.Format.dateRenderer(Ext.Date.patterns.ShortDateTime), dataIndex: 'creationDate'},
			        {stateId: 'grid-firedate', header: "<i18n:text i18n:key='PLUGINS_CORE_TOOLS_MESSAGES_TRACKER_TOOL_COL_FIREDATE'/>", width: 120, sortable: true, renderer: Ext.util.Format.dateRenderer(Ext.Date.patterns.ShortDateTime), dataIndex: 'fireDate'},
			        {stateId: 'grid-type', header: "<i18n:text i18n:key='PLUGINS_CORE_TOOLS_MESSAGES_TRACKER_TOOL_COL_TYPE'/>", width: 200, sortable: true, dataIndex: 'type'},
			        {stateId: 'grid-target', header: "<i18n:text i18n:key='PLUGINS_CORE_TOOLS_MESSAGES_TRACKER_TOOL_COL_TARGET'/>", flex: 1, sortable: true, dataIndex: 'target'},
			        {stateId: 'grid-callstack', header: "<i18n:text i18n:key='PLUGINS_CORE_TOOLS_MESSAGES_TRACKER_TOOL_COL_CALLSTACK'/>", flex: 0.5, sortable: true, hidden: true, dataIndex: 'callstack'}
			    ]
			});
		...
		onMessage: function(message)
		{
			...
			try
			{
				...
				var record = Ext.create("Ametys.plugins.core.system.messagetracker.MessageTrackerTool.MessageEntry", {
		...
		_targetsToString: function (targets, offset)
		{
			...
			{
				s = "<span style='color: #7f7f7f; font-style: italic;'><i18n:text i18n:key='PLUGINS_CORE_TOOLS_MESSAGES_TRACKER_TOOL_NOTARGET'/></span>";
			}

 ...
 * @private
 */
Ext.define("Ametys.runtime.navhistory.HistoryDAO.HistoryEntry", {
 ...
 */
Ext.define('Ametys.runtime.navhistory.HistoryDAO', {
	singleton: true,
	 ...
	 */
	SEARCH_TYPE: "<i18n:text i18n:key='PLUGINS_CMS_NAVHISTORY_DAO_SEARCH_TYPE'/>",
	
	/**
	 * @readonly
	 * @property {String} TOOL_TYPE Type for entries dealing with a tool
	 */
	TOOL_TYPE: "<i18n:text i18n:key='PLUGINS_CMS_NAVHISTORY_DAO_TOOL_TYPE'/>",
	
	/**
	 * @readonly
	 * @property {String} CONTENT_TYPE Type for entries dealing with a content
	 */
	CONTENT_TYPE: "<i18n:text i18n:key='PLUGINS_CMS_NAVHISTORY_DAO_CONTENT_TYPE'/>",

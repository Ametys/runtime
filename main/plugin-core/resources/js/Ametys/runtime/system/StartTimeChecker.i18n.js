 ...
 * @private
 */
Ext.define('Ametys.runtime.system.StartTimeChecker', {
    singleton: true,
    ...
    _messageCallback: function(response, args)
    {
        ...
        if (Ametys.data.ServerComm.handleBadResponse("<i18n:text i18n:key='PLUGINS_CMS_TOOL_STARTUPTIME_ERROR_TITLE'/>", response, 'Ametys.runtime.system.StartTimeChecker'))
        {
            return;
        }
        ...
        {
            Ametys.Msg.show({
                   title: (lastVersion == this._lastVersion) ? "<i18n:text i18n:key='PLUGINS_CMS_TOOL_STARTUPTIME_TITLE'/>" : "<i18n:text i18n:key='PLUGINS_CMS_TOOL_STARTUPTIME_TITLE2'/>",
                   msg: (lastVersion == this._lastVersion) ? "<i18n:text i18n:key='PLUGINS_CMS_TOOL_STARTUPTIME_MESSAGE'/>" : "<i18n:text i18n:key='PLUGINS_CMS_TOOL_STARTUPTIME_MESSAGE2'/>",
                   buttons: Ext.Msg.OK,
...
// Start the checker.
Ametys.runtime.system.StartTimeChecker._sendCheckMessage();

 ...
 * See {@link Ametys.runtime.uihelper.ChooseLocation}<br>
 * 
 * This widget is the default widget registered for fields of type Ametys.runtime.form.WidgetManager#TYPE_GEOCODE.<br>
 ...
 */
Ext.define('Ametys.runtime.form.widget.GeoCode', {
	 ...
	 */
	/**
	 * @cfg {String} chooseLocationWindowTitle Title of the dialog box to choose location. See {@link Ametys.runtime.uihelper.ChooseLocation#open}.
	 */
	/**
	 * @cfg {String} chooseLocationWindowIcon The full icon path the dialog box to choose location. See {@link Ametys.runtime.uihelper.ChooseLocation#open}. 
	 */
	/**
	 * @cfg {String} chooseLocationHelpMessage The help message to display on top of dialog box to choose location. See {@link Ametys.runtime.uihelper.ChooseLocation#open}. 
	 */
	/**
	 ...
	 */	
	buttonTooltipText : "<i18n:text i18n:key='WIDGET_GEOCODE_SHOW_MAP_BUTTON_TOOLTIP'/>",
	/**
	 ...
	 */	
	deleteTooltipText : "<i18n:text i18n:key='WIDGET_GEOCODE_DELETE_BUTTON'/>",
	/**
	 * @cfg {String} deletePopupTitle The title of the delete confirmation popup 
	 */	
	deleteTitle : "<i18n:text i18n:key='WIDGET_GEOCODE_DELETE_CONFIRM_TITLE'/>",
	/**
	 * @cfg {String} deleteConfirm The text of the delete confirmation popup 
	 */	
	deleteConfirm : "<i18n:text i18n:key='WIDGET_GEOCODE_DELETE_CONFIRM_CONTENT'/>",	
	/**
	 * @cfg {String} emptyText The text for empty field
	 */
	emptyText: "<i18n:text i18n:key='WIDGET_GEOCODE_NO_COORDINATES'/>",
	...
	_getAddressFormFields: function ()
	{
		...
		if (this._addressFieldNames.length > 0)
		{
			...
			Ext.each(this._addressFieldNames, function(fieldName)
			{
				...
				if (!field)
				{
					var message = "<i18n:text i18n:key='WIDGET_GEOCODE_UNKNOWN_FIELD'/>" + prefix + '.' + fieldName;
	...
	_openGoogleMap: function (defaultLatLng, defaultZoomLevel)
	{
		...
		Ametys.runtime.uihelper.ChooseLocation.open(config, Ext.bind(this._chooseLocationCallback, this));
	},
    ...
    */
	...
	_onInitialAddressChange: function()
	{
		if (this.getValue())
		{
			this.markWarning("<i18n:text i18n:key='WIDGET_GEOCODE_ADDRESS_CHANGE'/>");
		} 
	},

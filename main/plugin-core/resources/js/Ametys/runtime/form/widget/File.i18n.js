 ...
 * 
 * This widget is the default widget registered for fields of type Ametys.runtime.form.WidgetManager#TYPE_FILE and Ametys.runtime.form.WidgetManager#TYPE_BINARY.<br>
 * 
 ...
 * See the subclasses of {@link Ametys.runtime.form.widget.File.FileSource} for the available sources.<br>
 */
Ext.define('Ametys.runtime.form.widget.File', {
    ...
    statics: {
         ...
         * @param {Ametys.runtime.form.widget.File.FileSource} className The object class associated with this source
         */
         ...
         * @param {String} source The file source as such 'external', 'resource', ...
         * @return {Ametys.runtime.form.widget.File.FileSource} The file source class
         */
    ...
    inheritableStatics: {
    	...
    	filters: {
    		none: {
    			buttonMenuText: "",
    			buttonMenuTooltip: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_SELECT_FILE_BUTTON'/>",
    			buttonMenuIcon: Ametys.getPluginResourcesPrefix('cms') + '/img/widgets/resources-picker/file_local_16.png',
				
    			emptyText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_NO_FILE_SELECTED'/>",
    			
    			deleteText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_FILE_BUTTON'/>",
    			deleteTextConfirm: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_FILE_CONFIRM'/>",
    			
    			downloadText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DOWNLOAD_FILE'/>"
    		},
    		
    		image: {
    			buttonMenuText: "",
    			buttonMenuTooltip: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_SELECT_IMAGE_BUTTON'/>",
				buttonMenuIcon: Ametys.getPluginResourcesPrefix('cms') + '/img/widgets/resources-picker/image_local_16.png',
				
    			emptyText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_NO_IMAGE_SELECTED'/>",
    			
    			deleteText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_IMAGE_BUTTON'/>",
    			deleteTextConfirm: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_IMAGE_CONFIRM'/>",
    			
    			downloadText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DOWNLOAD_IMAGE'/>"
    		},
    		
    		multimedia: {
    			buttonMenuText: "",
    			buttonMenuTooltip: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_SELECT_MULTIMEDIA_BUTTON'/>",
    			buttonMenuIcon: Ametys.getPluginResourcesPrefix('cms') + '/img/widgets/resources-picker/multimedia_local_16.png',
				
    			emptyText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_NO_MULTIMEDIA_SELECTED'/>",
    			
    			deleteText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_MULTIMEDIA_BUTTON'/>",
    			deleteTextConfirm: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_MULTIMEDIA_CONFIRM'/>",
    			
    			downloadText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DOWNLOAD_MULTIMEDIA'/>"
    		},
    		
    		video: {
    			buttonMenuText: "",
    			buttonMenuTooltip: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_SELECT_VIDEO_BUTTON'/>",
    			buttonMenuIcon: Ametys.getPluginResourcesPrefix('cms') + '/img/widgets/resources-picker/multimedia_local_16.png',
				
    			emptyText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_NO_VIDEO_SELECTED'/>",
    			
    			deleteText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_VIDEO_BUTTON'/>",
    			deleteTextConfirm: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_VIDEO_CONFIRM'/>",
    			
    			downloadText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DOWNLOAD_VIDEO'/>"
    		},
    		
    		flash: {
    			buttonMenuText: "",
    			buttonMenuTooltip: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_SELECT_FLASH_BUTTON'/>",
    			buttonMenuIcon: Ametys.getPluginResourcesPrefix('cms') + '/img/widgets/resources-picker/multimedia_local_16.png',
				
    			emptyText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_NO_FLASH_SELECTED'/>",
    			
    			deleteText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_FLASH_BUTTON'/>",
    			deleteTextConfirm: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_FLASH_CONFIRM'/>",
    			
    			downloadText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DOWNLOAD_FLASH'/>"
    		},
    		
    		audio: {
    			buttonMenuText: "",
    			buttonMenuTooltip: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_SELECT_SOUND_BUTTON'/>",
    			buttonMenuIcon: Ametys.getPluginResourcesPrefix('cms') + '/img/widgets/resources-picker/sound_local_16.png',
				
    			emptyText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_NO_SOUND_SELECTED'/>",
    			
    			deleteText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_SOUND_BUTTON'/>",
    			deleteTextConfirm: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DELETE_SOUND_CONFIRM'/>",
    			
    			downloadText: "<i18n:text i18n:key='WIDGET_RESOURCES_PICKER_DOWNLOAD_SOUND'/>"
    		}
    	}
    },
    ...
    constructor: function (config)
    {
        ...
        // File localtion
        this.fileSources = config['allowSources'] ? config['allowSources'].split(',') : [Ametys.runtime.form.widget.File.External.SOURCE];
    ...
    getBtnConfig: function ()
    {
    	if (this.fileSources.length > 1)
    	{
    		...
    		{
    			var source = Ametys.runtime.form.widget.File.getFileSource(this.fileSources[i]);
    	...
    	{
    		var source = Ametys.runtime.form.widget.File.getFileSource(this.fileSources[0]);
    ...
    {
    	var source = Ametys.runtime.form.widget.File.getFileSource(btn.source);

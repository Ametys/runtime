...
/**
 * This class is the abstract class for all file sources used in {@link Ametys.runtime.form.widget.File} widget.<br>
 * Implement the #getFileType, #getBtnConfig, #getMenuItemConfig and #handler methods in your implementation. 
 * 
 * Do not forgot to register your class in {@link Ametys.runtime.form.widget.File} widget as the sample below:
 * 
 * 		Ametys.runtime.form.widget.File.registerFileSource ('MyType', MyTypeClass);
 * 
 */
Ext.define('Ametys.runtime.form.widget.File.FileSource', {

 ...
 */
Ext.define('Ametys.runtime.form.widget.AbstractQueryableComboBox', {
     ...
     */
	noResultText: "<i18n:text i18n:key='WIDGET_QUERYABLE_COMBOBOX_NO_RESULT'/>",
	/**
     * @cfg {String} loadingText The text while loading results
     */
	loadingText: "<i18n:text i18n:key='WIDGET_QUERYABLE_COMBOBOX_LOADING'/>",
    ...
    {
    	var data = {};
    	data[this.name] = this.combobox.getValue();
    	return data;
    },

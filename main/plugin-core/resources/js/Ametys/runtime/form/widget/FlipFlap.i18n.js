 ...
 * 
 * This widget is registered for enumerated and multiple fields of type Ametys.runtime.form.WidgetManager#TYPE_STRING.<br>
 */
Ext.define('Ametys.runtime.form.widget.FlipFlap', {
     ...
     */
    buttonsText: {
        top: "<i18n:text i18n:key='WIDGET_FLIPFLAP_MOVE_TO_TOP'/>",
        up: "<i18n:text i18n:key='WIDGET_FLIPFLAP_MOVE_UP'/>",
        add: "<i18n:text i18n:key='WIDGET_FLIPFLAP_ADD_TO_SELECTED'/>",
        remove: "<i18n:text i18n:key='WIDGET_FLIPFLAP_REMOVE_FROM_SELECTED'/>",
        down: "<i18n:text i18n:key='WIDGET_FLIPFLAP_MOVE_DOWN'/>",
        bottom: "<i18n:text i18n:key='WIDGET_FLIPFLAP_MOVE_TO_BOTTOM'/>"
    },

 ...
 * 
 * 		Ametys.runtime.form.WidgetManager.registerWidget(MyWidgetXType, MyWidgetXType, IsEnumeration, IsMultiple)
 * 		Ametys.runtime.form.WidgetManager.getWidget(MyWidgetXType, MyWidgetXType, MyWidgetConfig)
 */
Ext.define('Ametys.runtime.form.WidgetManager', {
	singleton: true,
	 ...
	 * @param {String} type (required) The type of widget such as Ametys.runtime.form.WidgetManager.TYPE_STRING, Ametys.runtime.form.WidgetManager.TYPE_DATE, ... Can not be null.
	 ...
	 * @param {String} type (required) The type of widget such as Ametys.runtime.form.WidgetManager.TYPE_STRING, Ametys.runtime.form.WidgetManager.TYPE_DATE, ...
	...
	_getDefaultWidgetXType: function (type, isEnumeration, isMultiple)
	{
		...
		if (!defaultWidgetsByType[type])
		{
			...
			{
				this.getLogger().warn("There is no default widget nor registered widget for type '" + type + "', default widget for type Ametys.runtime.form.WidgetManager#TYPE_STRING will be used");
	...
	getWidgetXType: function (xtype, type, isEnumeration, isMultiple)
	{
		...
		if (!widgetsByType[type])
		{
			this.getLogger().error("Unknown type '" + type + "' for widgets, Ametys.runtime.form.WidgetManager#TYPE_STRING will be used");
			type = Ametys.runtime.form.WidgetManager.TYPE_STRING;
		}

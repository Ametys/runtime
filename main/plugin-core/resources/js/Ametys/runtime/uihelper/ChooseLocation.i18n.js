 ...
 */
Ext.define('Ametys.runtime.uihelper.ChooseLocation', {
	...
	open: function (config, callback)
	{
		...
		Ametys.runtime.uihelper.ChooseLocation.LoadGoogleMaps.loadScript(
				Ext.bind(
						function(){
	...
	_delayedInitialize: function(config) 
	{
		...
		this._gmapwindow = Ext.create("Ametys.window.DialogBox",{
			title: config.title || "<i18n:text i18n:key='PLUGINS_CMS_GEOCODE_GMAP_DIALOG_DEFAULT_TITLE'/>",
			...
			items: {
				...
				items : [{
							xtype: 'component',
							cls: 'text',
							html: config.helpMessage || "<i18n:text i18n:key='PLUGINS_CMS_GEOCODE_GMAP_DIALOG_HELP_MSG_1'/>"
						},
						{
							// Search address bar
							xtype: 'panel',
							...
							items: [
							        {
							        	...
							        	fieldLabel: "<i18n:text i18n:key='PLUGINS_CMS_GEOCODE_GMAP_DIALOG_SEARCH_LABEL'/>",
							        	labelAlign: 'right',
							        	labelSeparator: '',
							        	labelWidth: 80,
							        ...
							        },
							        {
							        	...
							        	tooltip : "<i18n:text i18n:key='PLUGINS_CMS_GEOCODE_GMAP_DIALOG_SEARCH'/>",				
			...
			// Buttons
			buttons : [{
					text :"<i18n:text i18n:key='PLUGINS_CMS_GEOCODE_GMAP_DIALOG_OK'/>",
					handler: Ext.bind(this._ok, this)
				}, {
					text :'<i18n:text i18n:key="PLUGINS_CMS_GEOCODE_GMAP_DIALOG_CANCEL"/>',
	...
	pinAtAddress: function(anAddress) 
	{
		...
		geocoder.geocode(geocoderRequest, function (geocoderResults, geocoderStatus){
			...
			{
				me._setErrorSearchMessage("<i18n:text i18n:key='PLUGINS_CMS_GEOCODE_GMAP_DIALOG_SEARCH_NOT_FOUND'/>" + anAddress);
			}
		});
	},

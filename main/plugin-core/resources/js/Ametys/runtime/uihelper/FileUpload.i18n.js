 ...
 * See #open method.
 */
Ext.define('Ametys.runtime.uihelper.FileUpload', {
	singleton: true,
	 ...
	 * @readonly
	 */
	IMAGE_FILTER_LABEL: "<i18n:text i18n:key='PLUGINS_CMS_FILEUPLOAD_IMAGEFILTER'/>",
	 ...
	 * @readonly
	 */
	VIDEO_FILTER_LABEL: "<i18n:text i18n:key='PLUGINS_CMS_FILEUPLOAD_VIDEOFILTER'/>",
	 ...
	 * @readonly
	 */
	MULTIMEDIA_FILTER_LABEL: "<i18n:text i18n:key='PLUGINS_CMS_FILEUPLOAD_MULTIMEDIAFILTER'/>",
	 ...
	 * @readonly
	 */
	SOUND_FILTER_LABEL: "<i18n:text i18n:key='PLUGINS_CMS_FILEUPLOAD_SOUNDFILTER'/>",
	 ...
	 * @readonly
	 */
	FLASH_FILTER_LABEL: "<i18n:text i18n:key='PLUGINS_CMS_FILEUPLOAD_FLASHFILTER'/>",
		...
		if (!this._uploading)
		{
			...
			if (disabled)
			{
				Ametys.log.ErrorDialog.display({
					title: "<i18n:text i18n:key='PLUGINS_CMS_FILEUPLOAD_ERRORDIALOG_TEXT'/>", 
					text: "<i18n:text i18n:key='PLUGINS_CMS_FILEUPLOAD_ERRORDIALOG_DESC'/> " + Ametys.getObjectByName("Ametys.runtime.uihelper.FileUpload." + this._filter.$name + '_LABEL'),
		    		details: "",
		    		category: "Ametys.runtime.uihelper.FileUpload._selectFile"
				});
			}
		}
	},
	...
	_submitFailure: function (form, action)
	{
		...
		{
			Ametys.log.ErrorDialog.display({
				title: "<i18n:text i18n:key='PLUGINS_CMS_FILEUPLOAD_ERROR_MSG'/>", 
				text: "<i18n:text i18n:key='PLUGINS_CMS_FILEUPLOAD_ERROR_FILEREJECTED'/>",
	    		details: "",
	    		category: "Ametys.runtime.uihelper.FileUpload"
			});
		}
		else
		{
			Ametys.log.ErrorDialog.display({
				title: "<i18n:text i18n:key='PLUGINS_CMS_FILEUPLOAD_ERROR_MSG'/>", 
				text: "<i18n:text i18n:key='PLUGINS_CMS_FILEUPLOAD_ERROR_ON_SERVER'/>",

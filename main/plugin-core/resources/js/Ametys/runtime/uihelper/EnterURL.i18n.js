 ...
 * See #open method
 */
Ext.define('Ametys.runtime.uihelper.EnterURL', {
	singleton: true,
			...
			this._box = Ext.create('Ametys.window.DialogBox', {
				...
				items: [{
							...
							items: [{
									...
									{
										xtype: 'textfield',
										fieldLabel : "<i18n:text i18n:key='PLUGINS_CMS_HELPER_ENTERURL_LABEL'/>",
										name: 'url',
										itemId: 'url',
										width: 450,
				...
				closeAction: 'hide',
				buttons : [{
					text :"<i18n:text i18n:key='PLUGINS_CMS_HELPER_ENTERURL_OK'/>",
					handler : Ext.bind(this._ok, this)
				}, {
					text :"<i18n:text i18n:key='PLUGINS_CMS_HELPER_ENTERURL_CANCEL'/>",

 ...
 */
Ext.define('Ametys.runtime.uihelper.SaveErrorDialog', {
	singleton: true,
	...
	showErrorDialog: function (title, msg, detailedMsg)
	{
		...
		this._errorDialog.setTitle (title || "<i18n:text i18n:key='PLUGINS_CMS_SAVE_ACTION_FAILED_TITLE'/>");
	...
	_delayedInitialized: function ()
	{
		if (!this._initialized)
		{
			this._errorDialog = Ext.create('Ametys.window.DialogBox', {
		    	...
		    	title: "<i18n:text i18n:key='PLUGINS_CMS_SAVE_ACTION_FAILED_TITLE'/>",
				...
				closeAction: 'hide',
				buttons : [ {
						text : "<i18n:text i18n:key='PLUGINS_CMS_SAVE_ACTION_FAILED_OK_BTN'/>",

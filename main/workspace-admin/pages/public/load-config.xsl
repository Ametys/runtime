    ...
    <xsl:template match="/">
    	<xsl:call-template name="home">
		    ...
		    <xsl:with-param name="head-meta">
		    	<link rel="stylesheet" href="{$contextPath}{$workspaceURI}/resources/css/public/load-config.css" type="text/css"/>
		    </xsl:with-param>
		    ...
		    <xsl:with-param name="body-col-main">
                ...
                <div class="link">
                	<a href="{$contextPath}{$workspaceURI}/_plugins/{$redirect}" title="WORKSPACE_ADMIN_CONFIG_DESCRIPTION" i18n:attr="title">

...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="/GroupsManager">
        <html>
            <head>
                <title><i18n:text i18n:key="PLUGINS_CORE_GROUPS_LABEL" i18n:catalogue="plugin.core"/></title>
                <link rel="stylesheet" href="{$contextPath}/plugins/admin-old/resources/css/groups.css" type="text/css"/>      
            ...
            <script>
            	...
            	<script type="text/javascript" src="{$contextPath}/plugins/admin-old/resources/js/Ametys/plugins/admin/Groups.js"></script>

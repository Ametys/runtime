 ...
 * {@link org.ametys.runtime.util.BOMInputStream}.
 * 
 * @see org.ametys.runtime.util.BOMInputStream
...
public class ByteOrderMark implements Serializable
{
    ...
    public ByteOrderMark(String charsetName, int... bytes)
    {
        ...
        this._bytes = new int[bytes.length];
        System.arraycopy(bytes, 0, this._bytes, 0, bytes.length);
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (_bytes.length != bom.length())
        {
            return false;
        }
        for (int i = 0; i < _bytes.length; i++)
        {
            if (_bytes[i] != bom.get(i))
            {
                return false;
            }
        }
    ...
    public String toString()
    {
        ...
        for (int i = 0; i < _bytes.length; i++)
        {
            ...
            builder.append("0x");
            builder.append(Integer.toHexString(0xFF & _bytes[i]).toUpperCase());
        }
        builder.append(']');

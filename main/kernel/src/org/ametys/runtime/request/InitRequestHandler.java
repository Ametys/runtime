...
public interface InitRequestHandler
{
     ...
     * @param objectModel the Cocoon objectModel containing the Request, the Response
     * @throws Exception if an error occurred
     */
    public void initRequest(Redirector redirector, Map objectModel) throws Exception;
}

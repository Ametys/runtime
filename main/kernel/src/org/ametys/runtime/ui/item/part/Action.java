...
public class Action
{
    ...
    /**
     * Create an action that simply redirects inside the current workspace, by adding correct imports and launching a builtin class.<br>
     * The usage of a link Action requires that the workspace defines a runtimeRedirectTo(link, mode, plugin) JS function.
     * The provided helper in ui.xsl already provides such a function.
     * @param plugin the name of the plugin. Can be null.
     * @param url The url.
     * @param mode The link mode. The supported values actually depends on the workspace. <br>
     * The provided helper deals with {'absolute', 'context', 'workspace', 'plugin-direct', 'plugin-wrapped'}. 'plugin-wrapped' is the default value.
     * @return The action
     */
    public static Action createLinkAction(String plugin, String url, String mode)
    {
        // Ajoute l'import qui va bien

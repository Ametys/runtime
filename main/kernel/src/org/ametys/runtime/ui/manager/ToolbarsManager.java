...
public class ToolbarsManager extends AbstractLogEnabled implements Configurable, ThreadSafe, Serviceable, Disposable, Component
{
    ...
    /**
     * Check that a toolbar element configured really exists
     * @param element The toolbar element to check 
     * @throws IllegalStateException If the element is invalid
     */
    protected void _checkElement(ToolbarsElement element) throws IllegalStateException
    {
        ...
        else if (element instanceof Item)
        {
            ...
            UIItemFactory factory = _uiItemManager.getExtension(item.getId());
            if (factory == null)
            {
                String errorMessage = "An item referes an unexisting item factory with id '" + item.getId() + "'";
     ...
     * @return The ToolbarsElement
     * @throws ConfigurationException If an error occured while saxing
     */
    protected ToolbarsElement _configureElement(Configuration configuration) throws ConfigurationException
    {
    ...
    /**
     * SAX an element of the toolbar
     * @param handler The sax content handler
     * @param element The element to sax
     * @throws SAXException If an error occured while saxing
     */
    protected void _saxElement(ContentHandler handler, ToolbarsElement element) throws SAXException
    {
        if (element instanceof Separator)
        {
            _saxSeparator(handler);
    ...
    /**
     * Interface for toolbar's elements
     *
     */
    protected interface ToolbarsElement
    {
        // empty
    }
    
    /**
     * Class for separator toolbar element
     */
    protected class Separator implements ToolbarsElement
    {
        // extends
    }
     ...
     * Factory id 
     */
    protected class Item implements ToolbarsElement
    {
        private String _id;

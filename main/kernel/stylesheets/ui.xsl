...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template name="ui-tools-load">
        ...
        <xsl:param name="accept-ff-18.0">false</xsl:param>
        <xsl:param name="accept-ff-19.0">false</xsl:param>
        ...
        <xsl:param name="accept-ff-31.0">false</xsl:param>
        <xsl:param name="accept-ff-32.0">false</xsl:param>
        <xsl:param name="accept-ff-33.0">false</xsl:param>
        <xsl:param name="accept-ff-34.0">false</xsl:param>
        <xsl:param name="accept-ff-35.0">false</xsl:param>
        <xsl:param name="accept-ff-36.0">false</xsl:param>
        <xsl:param name="accept-ff-37.0">false</xsl:param>
        <xsl:param name="accept-ff-38.0">false</xsl:param>
        <xsl:param name="accept-ff-39.0">false</xsl:param>
        <xsl:param name="accept-ff-40.0">false</xsl:param>
        <xsl:param name="accept-ff-41.0">false</xsl:param>
        <xsl:param name="accept-ff-42.0">false</xsl:param>
        <xsl:param name="accept-ff-43.0">false</xsl:param>
        <xsl:param name="accept-ff-44.0">false</xsl:param>
        <xsl:param name="accept-ff-45.0">false</xsl:param>
        <xsl:param name="accept-ff-46.0">false</xsl:param>
        <xsl:param name="accept-ff-47.0">false</xsl:param>
        <xsl:param name="accept-ff-48.0">false</xsl:param>
        <xsl:param name="accept-ff-49.0">false</xsl:param>
        ...
        <xsl:param name="accept-ch-24">false</xsl:param>
        ...
        <xsl:param name="accept-ch-31">false</xsl:param>
        <xsl:param name="accept-ch-32">false</xsl:param>
        <xsl:param name="accept-ch-33">false</xsl:param>
        <xsl:param name="accept-ch-34">false</xsl:param>
        <xsl:param name="accept-ch-35">false</xsl:param>
        <xsl:param name="accept-ch-36">false</xsl:param>
        <xsl:param name="accept-ch-37">false</xsl:param>
        <xsl:param name="accept-ch-38">false</xsl:param>
        <xsl:param name="accept-ch-39">false</xsl:param>
        <xsl:param name="accept-ch-40">false</xsl:param>
        <xsl:param name="accept-ch-41">false</xsl:param>
        <xsl:param name="accept-ch-42">false</xsl:param>
        <xsl:param name="accept-ch-43">false</xsl:param>
        <xsl:param name="accept-ch-44">false</xsl:param>
        <xsl:param name="accept-ch-45">false</xsl:param>
        <xsl:param name="accept-ch-46">false</xsl:param>
        <xsl:param name="accept-ch-47">false</xsl:param>
        <xsl:param name="accept-ch-48">false</xsl:param>
        <xsl:param name="accept-ch-49">false</xsl:param>
        <xsl:param name="accept-ch-50">false</xsl:param>
        <xsl:param name="accept-ch-51">false</xsl:param>
        <xsl:param name="accept-ch-52">false</xsl:param>
        <xsl:param name="accept-ch-53">false</xsl:param>
        <xsl:param name="accept-ch-54">false</xsl:param>
	        ...
	        <script type="text/javascript">
	            <xsl:comment>
	                ...
	                <xsl:text>if (!(</xsl:text>
                        ...
                        <xsl:if test="$accept-ff-18.0 = 'true'">(userAgent.indexOf("firefox/18.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-19.0 = 'true'">(userAgent.indexOf("firefox/19.0") >= 0) ||</xsl:if>
	                    ...
	                    <xsl:if test="$accept-ff-31.0 = 'true'">(userAgent.indexOf("firefox/31.0") >= 0) ||</xsl:if>
	                    <xsl:if test="$accept-ff-32.0 = 'true'">(userAgent.indexOf("firefox/32.0") >= 0) ||</xsl:if>
	                    <xsl:if test="$accept-ff-33.0 = 'true'">(userAgent.indexOf("firefox/33.0") >= 0) ||</xsl:if>
	                    <xsl:if test="$accept-ff-34.0 = 'true'">(userAgent.indexOf("firefox/34.0") >= 0) ||</xsl:if>
	                    <xsl:if test="$accept-ff-35.0 = 'true'">(userAgent.indexOf("firefox/35.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-36.0 = 'true'">(userAgent.indexOf("firefox/36.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-37.0 = 'true'">(userAgent.indexOf("firefox/37.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-38.0 = 'true'">(userAgent.indexOf("firefox/38.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-39.0 = 'true'">(userAgent.indexOf("firefox/39.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-40.0 = 'true'">(userAgent.indexOf("firefox/40.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-41.0 = 'true'">(userAgent.indexOf("firefox/41.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-42.0 = 'true'">(userAgent.indexOf("firefox/42.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-43.0 = 'true'">(userAgent.indexOf("firefox/43.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-44.0 = 'true'">(userAgent.indexOf("firefox/44.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-45.0 = 'true'">(userAgent.indexOf("firefox/45.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-46.0 = 'true'">(userAgent.indexOf("firefox/46.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-47.0 = 'true'">(userAgent.indexOf("firefox/47.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-48.0 = 'true'">(userAgent.indexOf("firefox/48.0") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ff-49.0 = 'true'">(userAgent.indexOf("firefox/49.0") >= 0) ||</xsl:if>
                        ...
                        <xsl:if test="$accept-ch-31  = 'true'">(userAgent.indexOf("chrome/31.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-32  = 'true'">(userAgent.indexOf("chrome/32.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-33  = 'true'">(userAgent.indexOf("chrome/33.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-34  = 'true'">(userAgent.indexOf("chrome/34.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-35  = 'true'">(userAgent.indexOf("chrome/35.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-36  = 'true'">(userAgent.indexOf("chrome/36.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-37  = 'true'">(userAgent.indexOf("chrome/37.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-38  = 'true'">(userAgent.indexOf("chrome/38.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-39  = 'true'">(userAgent.indexOf("chrome/39.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-40  = 'true'">(userAgent.indexOf("chrome/40.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-41  = 'true'">(userAgent.indexOf("chrome/41.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-42  = 'true'">(userAgent.indexOf("chrome/42.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-43  = 'true'">(userAgent.indexOf("chrome/43.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-44  = 'true'">(userAgent.indexOf("chrome/44.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-45  = 'true'">(userAgent.indexOf("chrome/45.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-46  = 'true'">(userAgent.indexOf("chrome/46.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-47  = 'true'">(userAgent.indexOf("chrome/47.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-48  = 'true'">(userAgent.indexOf("chrome/48.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-49  = 'true'">(userAgent.indexOf("chrome/49.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-50  = 'true'">(userAgent.indexOf("chrome/50.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-51  = 'true'">(userAgent.indexOf("chrome/51.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-52  = 'true'">(userAgent.indexOf("chrome/52.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-53  = 'true'">(userAgent.indexOf("chrome/53.") >= 0) ||</xsl:if>
                        <xsl:if test="$accept-ch-54  = 'true'">(userAgent.indexOf("chrome/54.") >= 0) ||</xsl:if>

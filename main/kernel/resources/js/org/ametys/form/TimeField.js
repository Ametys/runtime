 ...
 */
org.ametys.form.TimeField = function(config) 
{
	config.itemCls = "ametys-input";
	config.labelSeparator = '';
	
	org.ametys.form.TimeField.superclass.constructor.call(this, config);
}; 
...
{
	org.ametys.form.TimeField.superclass.onRender.call(this, ct, position);

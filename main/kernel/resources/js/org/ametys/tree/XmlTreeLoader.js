 ...
 */
org.ametys.tree.XmlTreeLoader = Ext.extend(Ext.tree.TreeLoader, {});

/**
 * @property XML_NODE_ELEMENT XML element node (value 1, read-only)
 * @type Number
 */
org.ametys.tree.XmlTreeLoader.prototype.XML_NODE_ELEMENT = 1;

/**
 * @property XML_NODE_TEXT XML text node (value 3, read-only)
 * @type Number
 */
org.ametys.tree.XmlTreeLoader.prototype.XML_NODE_TEXT = 3;

// private override
org.ametys.tree.XmlTreeLoader.prototype.processResponse = function(response, node, callback) 
{
...
org.ametys.tree.XmlTreeLoader.prototype.setNodeTags = function ()
{
	// Nothing
}
...
org.ametys.tree.XmlTreeLoader.prototype.createNode = function(node) 
{
	...
	return org.ametys.tree.XmlTreeLoader.superclass.createNode.call(this, attr);
}

/**
 * Template method intended to be overridden by subclasses that need to provide
 * custom attribute processing prior to the creation of each TreeNode. This
 * method will be passed a config object containing existing TreeNode attribute
 * name/value pairs which can be modified as needed directly (no need to return
 * the object).
 */
org.ametys.tree.XmlTreeLoader.prototype.processAttributes = Ext.emptyFn;

...
SListView.prototype.select = function (elt, controlKey)
{
	// CTRL
	if (this.multipleSelection == true && controlKey == true)
	{
	...
	if (this.listener != null && this.listener.onSelect != null && !this.listener.onSelect(elt.element))
		return;
	
	this.selection.push(elt);
	elt.element.selected = true;
...
SListView.prototype.create_mozaic = function (element)
{
	...
	var func = function (e) {
		...
		this.slistview.select(this, controlKey); 

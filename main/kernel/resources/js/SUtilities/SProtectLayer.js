...
SProtectLayer.prototype.setEventListener = function(event, listener)
{
  ...
  var iframeEventElt = SUtilities.IS_IE ? this._iframe.contentWindow.document.getElementById('alone') : this._iframe;
  ...
  switch (event)
  {
    ...
    case "onshow":
      ...
      break;
    case "onfocus":
      this._iframe.onfocus = listener;
      break;
    case "onclick":
      SUtilities.attachEvent(iframeEventElt, "click", listener);
      break;
    case "ondblclick":
      SUtilities.attachEvent(iframeEventElt, "dblclick", listener);
      break;
    case "onmousedown":
      SUtilities.attachEvent(iframeEventElt, "mousedown", listener);
      break;
    case "onmousemove":
      SUtilities.attachEvent(iframeEventElt, "mousemove", listener);
      break;
    case "onmouseover":
      SUtilities.attachEvent(iframeEventElt, "mouseover", listener);
      break;
    case "onmouseout":
      SUtilities.attachEvent(iframeEventElt, "mouseout", listener);
      break;
    case "onmouseup":
      SUtilities.attachEvent(iframeEventElt, "mouseup", listener);
      break;
  }
}
...
SProtectLayer.prototype._dispose = function()
{
	if (this._iframe != null)
	{
        ...
        if (this._event["onclick"] != null)
          SUtilities.detachEvent(iframeEventElt, "click", this._event["onclick"]);
        if (this._event["ondblclick"] != null)
          SUtilities.detachEvent(iframeEventElt, "dblclick", this._event["ondblclick"]);
        if (this._event["onmousedown"] != null)
          SUtilities.detachEvent(iframeEventElt, "mousedown", this._event["onmousedown"]);
        if (this._event["onmousemove"] != null)
          SUtilities.detachEvent(iframeEventElt, "mousemove", this._event["onmousemove"]);
        if (this._event["onmouseover"] != null)
          SUtilities.detachEvent(iframeEventElt, "mouseover", this._event["onmouseover"]);
        if (this._event["onmouseout"] != null)
          SUtilities.detachEvent(iframeEventElt, "mouseout", this._event["onmouseout"]);
        if (this._event["onmouseup"] != null)
          SUtilities.detachEvent(iframeEventElt, "mouseup", this._event["onmouseup"]);

		this._iframe.onfocus = null;
...
SProtectLayer.prototype._create = function()
{
    ...
    {
        this._iframe = this._document.createElement('div');
    }
    ...
    {
       this._iframe.style.backgroundColor = "#ffffff";
    }
}
...
SProtectLayer.prototype.setStyle = function(attribute, value)
{
    ...
    {
       this._iframe.style[attribute] = value;
	}
}
         ...
         do
         {
                 ...
                 if (elementIsBody || (elementIsAbsolutlyPositionned && elementZIndex != null))
                 {
                 	if (elementIsBody || elementZIndex < highestLevel)
                 	{
                        ...
                        {
                             SProtectLayer._highestInstance._iframe.focus();
                        }
                 		SProtectLayer._checkEvents();
                 	}
                        return;

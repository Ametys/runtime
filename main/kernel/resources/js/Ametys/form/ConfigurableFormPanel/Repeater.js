...
//        panel.expand(opt.animate !== false);
    ...
    getErrors: function ()
    {
        ...
        {
    		errors.push("<i18n:text i18n:key='CONFIGURABLE_FORM_REPEATER_INSERT_INVALID_MINSIZE'/>: " + this.getItemCount() + '/' +  this.minSize);
        }
    	
    	if (this.maxSize != null && this.getItemCount() > this.maxSize)
        {
    		errors.push("<i18n:text i18n:key='CONFIGURABLE_FORM_REPEATER_INSERT_INVALID_MAXSIZE'/>: " + this.getItemCount() + '/' +  this.maxSize);
        }
    ...
    _downTool: function()
    {
    	return {
    	    type: 'down',
    		qtip: "<i18n:text i18n:key='CONFIGURABLE_FORM_REPEATER_MOVE_DOWN'/>", 
    		handler: this._down,
            scope: this
    	};
    },
    ...
    _upTool: function()
    {
    	return {
    	    type: 'up',
    		qtip: "<i18n:text i18n:key='CONFIGURABLE_FORM_REPEATER_MOVE_UP'/>", 
    		handler: this._up,
    		scope: this
    	};
    },
    ...
    _add: function(event, toolEl, header, tool)
    {
        ...
        {
            Ametys.Msg.show({
                title: "<i18n:text i18n:key='CONFIGURABLE_FORM_REPEATER_INSERT'/>",
                msg: "<i18n:text i18n:key='CONFIGURABLE_FORM_REPEATER_INSERT_ERROR_MAXSIZE'/>",
                buttons: Ext.Msg.OK,
    ...
    _delete: function(itemPanel)
    {
        ...
        {
            Ametys.Msg.show({
                title: "<i18n:text i18n:key='CONFIGURABLE_FORM_REPEATER_DELETE'/>",
                msg: "<i18n:text i18n:key='CONFIGURABLE_FORM_REPEATER_DELETE_ERROR_MINSIZE'/>",
                buttons: Ext.Msg.OK,
                icon: Ext.MessageBox.ERROR
            });
            return;
        ...
        // Confirm deletion
        Ametys.Msg.confirm(
			"<i18n:text i18n:key='CONFIGURABLE_FORM_REPEATER_DELETE'/>",
			"<i18n:text i18n:key='CONFIGURABLE_FORM_REPEATER_DELETE_CONFIRM'/>",
			function (answer)
			{
				if (answer == 'yes')
				{

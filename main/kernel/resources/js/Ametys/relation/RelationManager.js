...
Ext.define("Ametys.relation.RelationManager", 
	{
		...
		link: function(source, target, callback, relationType, handlerchoice)
		{
			...
			if (indexes.length == 0)
			{
				Ametys.Msg.alert("<i18n:text i18n:key='PLUGINS_CMS_RELATIONS_UNSUPPORTED_MOVE_LABEL' i18n:catalogue='plugin.cms'/>", "<i18n:text i18n:key='PLUGINS_CMS_RELATIONS_UNSUPPORTED_MOVE_DESCRIPTION' i18n:catalogue='plugin.cms'/>");

...
Ext.define("Ametys.tool.Tool", 
	{
		...
		showOutOfDate: function(major)
		{
			...
			if (major)
			{
				...
				{
					this._contentPanel.mask("<i18n:text i18n:key='KERNEL_MSG_TOOLS_OUTOFDATEPANEL_MAJOR'/>", "ametys-mask-unloading");
				}
				else
				{
		...
		/**
		 * Ask the server for processing through a java "callable" method of the component used to declare this tool.

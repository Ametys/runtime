...
Ext.MessageBox = Ext.Msg = {
    ...
    OK : Ext.window.MessageBox.prototype.OK,
    YES : Ext.window.MessageBox.prototype.YES,
    NO : Ext.window.MessageBox.prototype.NO,
    CANCEL : Ext.window.MessageBox.prototype.CANCEL,
    OKCANCEL : Ext.window.MessageBox.prototype.OKCANCEL,
    YESNO : Ext.window.MessageBox.prototype.YESNO,
    YESNOCANCEL : Ext.window.MessageBox.prototype.YESNOCANCEL,
    INFO : Ext.window.MessageBox.prototype.v,
    WARNING : Ext.window.MessageBox.prototype.WARNING,
    QUESTION : Ext.window.MessageBox.prototype.QUESTION,
    ERROR : Ext.window.MessageBox.prototype.ERROR,

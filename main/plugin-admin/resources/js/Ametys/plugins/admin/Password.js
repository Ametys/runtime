...
Ext.define('Ametys.plugins.admin.Password', {
	singleton: true,
	...
	delayedInitialize: function ()
	{
	    ...
	    this._form = new Ext.FormPanel({
			...
			items:[ 
			        ...
			        new Ext.form.field.Text({
			        	fieldLabel :"<i18n:text i18n:key='PLUGINS_ADMIN_PASSWORD_OLD'/>",
			        	name: 'oldPassword',
				        ...
				        inputType:"password",
				        msgTarget: 'side',
				        blankText: "<i18n:text i18n:key='PLUGINS_ADMIN_PASSWORD_CHANGE_ERROR_MANDATORY'/>"
			        }), 
			        
			        // New password
			        new Ext.form.field.Text({
			        	fieldLabel :"<i18n:text i18n:key='PLUGINS_ADMIN_PASSWORD_NEW'/>",
			        	name :'newPassword',
			        ...
			        // Confirm password
			        new Ext.form.field.Text({
						fieldLabel: "<i18n:text i18n:key='PLUGINS_ADMIN_PASSWORD_CONFIRM'/>",
	    ...
	    this.box = new Ametys.window.DialogBox({
	    	...
	    	title :"<i18n:text i18n:key='PLUGINS_ADMIN_PASSWORD_DIALOG_CAPTION'/>",
	    	icon : Ametys.getPluginResourcesPrefix(this.pluginName) + "/img/password/password_16.png",
			...
			closeAction: 'hide',
			buttons : [ {
					text :"<i18n:text i18n:key='PLUGINS_ADMIN_PASSWORD_DIALOG_OK'/>",
					handler : Ext.bind(this.ok, this)
				}, {
					text :"<i18n:text i18n:key='PLUGINS_ADMIN_PASSWORD_DIALOG_CANCEL'/>",
	...
	ok: function()
	{
		...
		{
			confirmPassword.markInvalid("<i18n:text i18n:key='PLUGINS_ADMIN_PASSWORD_CHANGE_ERROR_WRONG_CONFIRM'/>");
			return;
		}
	    ...
	    if (Ametys.data.ServerComm.handleBadResponse("<i18n:text i18n:key='PLUGINS_ADMIN_PASSWORD_CHANGE_ERROR_FATAL'/>", result, "this.ok"))
	    {
	       return;
	    }
		...
		Ametys.Msg.show ({
			title: "<i18n:text i18n:key='PLUGINS_ADMIN_PASSWORD_LABEL'/>",
			msg: "<i18n:text i18n:key='PLUGINS_ADMIN_PASSWORD_CHANGE_OK'/>",
			buttons: Ext.Msg.OK,

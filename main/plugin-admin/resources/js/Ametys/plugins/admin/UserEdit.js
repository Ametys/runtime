 ...
 * @private
 */
Ext.define('Ametys.plugins.admin.UserEdit', {
	singleton: true,
	...
	delayedInitialize: function()
	{
		...
		this.box = new Ametys.window.DialogBox({
			...
			icon: Ametys.getPluginResourcesPrefix('admin') + '/img/users/icon_small.png',
	...
	act: function(params, callback)
	{
	    ...
	    else
	    {
	        ...
	        if (Ametys.data.ServerComm.handleBadResponse("<i18n:text i18n:key='PLUGINS_CORE_USERS_DIALOG_ERROR'/>", nodes, "Ametys.plugins.admin.UserEdit.act"))
	        {
	           return;
	        }
	...
	ok: function ()
	{
	    ...
	    if (Ametys.data.ServerComm.handleBadResponse("<i18n:text i18n:key='PLUGINS_CORE_USERS_DIALOG_ERROR'/>", result, "Ametys.plugins.admin.UserEdit.ok"))
	    {
	       return;
	    }

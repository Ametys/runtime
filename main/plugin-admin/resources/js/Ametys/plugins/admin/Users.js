...
Ext.define('Ametys.plugins.admin.Users', {
	...
	impersonate: function ()
	{
	    ...
	    if (Ametys.data.ServerComm.handleBadResponse("<i18n:text i18n:key='PLUGINS_CORE_USERS_IMPERSONATE_ERROR'/>", (result == null || Ext.dom.Query.selectValue("*/error", result, "") != "") ? null : result, "Ametys.plugins.admin.Users.impersonate"))
	    {
	       return;
	    }
	    else
	...
	search: function ()
	{
	    ...
	    if (Ametys.data.ServerComm.handleBadResponse("<i18n:text i18n:key='PLUGINS_CORE_USERS_SEARCHING_ERROR'/>", result, "Ametys.plugins.admin.Users.search"))
	    {
	       return;
	    }

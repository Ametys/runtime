...
Ext.define('Ametys.plugins.admin.Profiles', {
	...
	createProfile: function()
	{
        ...
        if (Ametys.data.ServerComm.handleBadResponse("<i18n:text i18n:key='PLUGINS_CORE_RIGHTS_PROFILES_NEW_ERROR'/>", result, "Ametys.plugins.admin.Logs.createProfile"))
        {
            return;
        }
        else
    ...
    saveObjects: function(element, objects, newRights)
    {
		...
		while (!ok)
		{
		    ...
		    if (Ametys.data.ServerComm.handleBadResponse("<i18n:text i18n:key='PLUGINS_CORE_RIGHTS_PROFILES_MODIFY_ERROR'/>", result, "Ametys.plugins.admin.Logs.saveObjects"))
		    {
				return;
		    }
		    else
	...
	editLabel: function(editor, e, eOpts)
	{
		if (e.record.get('id') == "new")
		{
		    ...
		    if (Ametys.data.ServerComm.handleBadResponse("<i18n:text i18n:key='PLUGINS_CORE_RIGHTS_PROFILES_NEW_ERROR'/>", result, "Ametys.plugins.admin.Logs.editLabel"))
		    {
		       return;
		    }
			else
		...
		else
		{
		    ...
		    if (Ametys.data.ServerComm.handleBadResponse("<i18n:text i18n:key='PLUGINS_CORE_RIGHTS_PROFILES_RENAME_ERROR'/>", result, "Ametys.plugins.admin.Logs.editLabel"))
		    {
		       return;
		    }
			else 
	...
	createPanel: function(readItems, editItems) 
	{
		...
		this._Category.addAction("<i18n:text i18n:key='PLUGINS_CORE_RIGHTS_PROFILES_HANDLE_CREATE'/>", null, Ametys.getPluginResourcesPrefix('admin') + "/img/profiles/new.png", Ext.bind(this.createProfile, this));
		this._Category.addAction("<i18n:text i18n:key='PLUGINS_CORE_RIGHTS_PROFILES_HANDLE_RENAME'/>", null, Ametys.getPluginResourcesPrefix('admin') + "/img/profiles/rename.png", Ext.bind(this.rename, this));
		this._Category.addAction("<i18n:text i18n:key='PLUGINS_CORE_RIGHTS_PROFILES_HANDLE_VALIDATE'/>", null, Ametys.getPluginResourcesPrefix('admin') + "/img/profiles/validate.png", Ext.bind(this.saveObjects, this, []));
		this._Category.addAction("<i18n:text i18n:key='PLUGINS_CORE_RIGHTS_PROFILES_HANDLE_DELETE'/>", null, Ametys.getPluginResourcesPrefix('admin') + "/img/profiles/delete.png", Ext.bind(this.remove, this));
		this._Category.addAction("<i18n:text i18n:key='PLUGINS_CORE_RIGHTS_PROFILES_HANDLE_QUIT'/>", null, Ametys.getPluginResourcesPrefix('admin') + "/img/profiles/quit.png", Ext.bind(this.goBack, this));
		...
		this._utilsCategory.addAction("<i18n:text i18n:key='PLUGINS_CORE_RIGHTS_PROFILES_SELECT_ALL'/>", null, Ametys.getPluginResourcesPrefix('admin') + "/img/profiles/select_all.png", Ext.bind(this.selectAll, this, []));
		this._utilsCategory.addAction("<i18n:text i18n:key='PLUGINS_CORE_RIGHTS_PROFILES_UNSELECT_ALL'/>", null, Ametys.getPluginResourcesPrefix('admin') + "/img/profiles/unselect_all.png", Ext.bind(this.unselectAll, this, []));
		this._utilsCategory.setVisible(false);
	...
	onRender: function(ct, position)
	{
		...
		if (this.description)
		{
			var img = this.getEl().createChild({
				...
				cls: 'right-entry-img',
				tag:'img',
				src: Ametys.getPluginResourcesPrefix('admin') + '/img/config/help.gif'});

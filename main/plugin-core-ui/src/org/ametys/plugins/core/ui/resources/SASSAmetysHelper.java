 ...
 * Inherited methods are NOT injected. For this reason, method that must not be accessed from Sass have to be declared in the parent class AbstractSASSAmetysHelper
 */
public class SASSAmetysHelper extends AbstractSASSAmetysHelper implements Component
{
    /** Avalon ROLE. */
    public static final String ROLE = SASSAmetysHelper.class.getName();

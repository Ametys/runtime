    ...
    _saveStateCB: function(success, errors)
    {
    	if (success == false && errors != null)
    	{
    	    ...
    	    Ametys.log.ErrorDialog.display({
    	        title: "<i18n:text i18n:key='PLUGINS_CORE_UI_USER_PREFERENCES_STATE_PROVIDER_SAVE_FAILURE_TITLE'/>",
    	        text: "<i18n:text i18n:key='PLUGINS_CORE_UI_USER_PREFERENCES_STATE_PROVIDER_SAVE_FAILURE_DESC'/>",
    	        details: details,

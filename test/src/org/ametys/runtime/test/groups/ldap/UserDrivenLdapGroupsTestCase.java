...
public class UserDrivenLdapGroupsTestCase extends AbstractLdapGroupsTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        _startApplication("test/environments/runtimes/runtime9.xml", "test/environments/configs/config4.xml", null, "test/environments/datasources/datasource-ldap.xml", "test/environments/webapp1");
    ...
    {
        // DEFAULT IMPL
        assertTrue(_groupsManager instanceof UserDrivenLdapGroupsManager);

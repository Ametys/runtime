...
/**
 * MySQL-specific JDBC GroupsManager test case.
 */
public class MysqlJdbcGroupsTestCase extends AbstractJdbcGroupsTestCase
{
    @Override
    ...
    {
        return new File[] {new File("test/environments/scripts/jdbc-mysql/fillJDBCUsersAndGroups.sql")};
    }
}

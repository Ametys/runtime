...
/**
 * Test suite for credentials aware UsersManagers.
 */
public final class AllCredentialsAwareJdbcUsersTestSuite extends TestSuite
{
    
    private AllCredentialsAwareJdbcUsersTestSuite()
    {
        // empty constructor
    }

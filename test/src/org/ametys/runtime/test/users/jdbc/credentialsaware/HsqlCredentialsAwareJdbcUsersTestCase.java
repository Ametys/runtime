...
/**
 * Derby-specific credentials aware JDBC UsersManager test case.
 */
public class HsqlCredentialsAwareJdbcUsersTestCase extends AbstractCredentialsAwareJdbcUsersTestCase
{

    @Override
    protected void setUp() throws Exception
    {
        _resetDB("runtime7.xml", "config1.xml", "datasource-hsql.xml");
    }
...
//    protected File[] getPopulateScripts()
//    {
//        return new File[] {new File("test/environments/scripts/jdbc-hsqldb/fillJDBCUsersAuth.sql")};
//    }

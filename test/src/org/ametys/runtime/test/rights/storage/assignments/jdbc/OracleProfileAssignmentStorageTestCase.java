...
/**
 * Oracle-specific JDBC ProfileAssignement storage test case.
 */
public class OracleProfileAssignmentStorageTestCase extends AbstractJdbcProfileAssignmentStorageTestCase
{
    @Override

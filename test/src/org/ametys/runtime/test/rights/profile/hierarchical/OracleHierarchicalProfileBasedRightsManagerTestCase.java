...
/**
 * Oracle-specific JDBC HierarchicalProfileBasedRightsManager test case.
 */
public class OracleHierarchicalProfileBasedRightsManagerTestCase extends AbstractHierarchicalProfileBasedRightsManagerTestCase
{
    
    @Override
    protected void setUp() throws Exception
    {
        _resetDB("runtime5.xml", "config1.xml", "datasource-oracle.xml");
    }

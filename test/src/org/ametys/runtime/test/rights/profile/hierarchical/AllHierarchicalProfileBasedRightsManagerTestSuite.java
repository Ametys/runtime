...
/**
 * Test suite for HierarchicalProfileBasedRightsManager test.
 */
public final class AllHierarchicalProfileBasedRightsManagerTestSuite extends TestSuite
{
    
    private AllHierarchicalProfileBasedRightsManagerTestSuite()
    {
        // empty constructor
    }
    ...
    {
        TestSuite suite = new TestSuite("Test HierarchicalProfileBasedRightsManager with all DBMS");

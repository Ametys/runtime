...
/**
 * Test suite for ProfileBasedRightsManager test.
 */
public final class AllProfileBasedRightsManagerTestSuite extends TestSuite
{
    
    private AllProfileBasedRightsManagerTestSuite()
    {
        // empty constructor
    }
    ...
    {
        TestSuite suite = new TestSuite("Test ProfileBasedRightsManager with all DBMS");

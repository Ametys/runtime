...
/**
 * Derby-specific JDBC HierarchicalProfileBasedRightsManager test case.
 */
public class HsqlHierarchicalProfileBasedRightsManagerTestCase extends AbstractHierarchicalProfileBasedRightsManagerTestCase
{
    ...
    {
        return new File[] {new File("test/environments/scripts/jdbc-hsqldb/fillProfileRights.sql")};
    }

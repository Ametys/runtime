 ...
 */
public class MenusManagerTestCase extends AbstractTestCase
{
    ...
    public void testSax() throws Exception
    {
        ...
        assertEquals("true", xpath.evaluateAsString(testNode, "label/@i18n"));
        assertEquals("application", xpath.evaluateAsString(testNode, "label/catalogue"));
        assertEquals("MENU1", xpath.evaluateAsString(testNode, "label/key"));
        ...
        assertEquals("true", xpath.evaluateAsString(testNode, "items/*[5]/label/@i18n"));
        assertEquals("application", xpath.evaluateAsString(testNode, "items/*[5]/label/catalogue"));
        assertEquals("SUBMENU1", xpath.evaluateAsString(testNode, "items/*[5]/label/key"));
        ...
        assertEquals("true", xpath.evaluateAsString(testNode, "label/@i18n"));
        assertEquals("application", xpath.evaluateAsString(testNode, "label/catalogue"));
        assertEquals("MENU2", xpath.evaluateAsString(testNode, "label/key"));
        ...
        assertEquals("true", xpath.evaluateAsString(testNode, "items/*[3]/label/@i18n"));
        assertEquals("application", xpath.evaluateAsString(testNode, "items/*[3]/label/catalogue"));
        assertEquals("SUBMENU2", xpath.evaluateAsString(testNode, "items/*[3]/label/key"));
        ...
        assertEquals("true", xpath.evaluateAsString(testNode, "label/@i18n"));
        assertEquals("application", xpath.evaluateAsString(testNode, "label/catalogue"));
        assertEquals("MENU3", xpath.evaluateAsString(testNode, "label/key"));

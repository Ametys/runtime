...
*/
   ...
   Ametys.ribbon.RibbonManager.registerElement(control);
/*
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.site.SiteActions.configure","selection-target-type":"^(site)$","label":"Configurer","description":"Modifie la configuration du site.<br/><br/>Naviguez en utilisant les onglets et modifiez les valeurs des paramètres.","icon-small":"/plugins/web/resources/img/uitool-site/configure_site_16.png","icon-medium":"/plugins/web/resources/img/uitool-site/configure_site_32.png","icon-large":"/plugins/web/resources/img/uitool-site/configure_site_48.png"}, {id: "org.ametys.web.admin.site.Configure", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);

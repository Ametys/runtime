...
*/
   ...
   Ametys.ribbon.RibbonManager.registerElement(control);
/*
   control = Ext.create("Ametys.plugins.core.profiles.controller.SelectRightsController", Ext.apply({"action":"Ametys.plugins.core.profiles.ProfilesTool.unselectAll","disabled":"true","selection-target-type":"^profile$","selection-subtarget-type":"^form$","label":"Désélectionner tout","description":"Désélectionne tous les droits","icon-small":"/plugins/core/resources/img/profiles/unselect_16.png","icon-medium":"/plugins/core/resources/img/profiles/unselect_32.png","icon-large":"/plugins/core/resources/img/profiles/unselect_48.png"}, {id: "org.ametys.core.profiles.UnselectAll", pluginName: "core"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
*/
   control = Ext.create("Ametys.ribbon.element.ui.button.OpenToolButtonController", Ext.apply({"opentool-role":"uitool-admin-logs","label":"Visualisation","description":"Visualiser les journaux de l'application","icon-small":"/plugins/admin/resources/img/logs/logs_16.png","icon-medium":"/plugins/admin/resources/img/logs/logs_32.png","icon-large":"/plugins/admin/resources/img/logs/logs_48.png"}, {id: "org.ametys.plugins.admin.Logs", pluginName: "admin"}));
   Ametys.ribbon.RibbonManager.registerElement(control);

   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.admin.logs.LogsActions.view","selection-target-type":"^logfile$","selection-enable-multiselection":"false","label":"Voir","description":"Voir le fichier sélectionné","icon-small":"/plugins/admin/resources/img/logs/view_16.png","icon-medium":"/plugins/admin/resources/img/logs/view_32.png","icon-large":"/plugins/admin/resources/img/logs/view_48.png"}, {id: "org.ametys.plugins.admin.logs.View", pluginName: "admin"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
...
*/
   ...
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.admin.plugins.PluginsActions.deactivate","selection-target-type":"^(plugin-by-file-node|plugin-by-extension-point-node)$","selection-target-parameter":{"name":"^activeFeature$","value":"true"},"label":"Désactiver","description":"Permet de désactiver la feature sélectionnée.","icon-small":"/plugins/admin/resources/img/plugins/deactivate_16.png","icon-medium":"/plugins/admin/resources/img/plugins/deactivate_32.png","icon-large":"/plugins/admin/resources/img/plugins/deactivate_48.png"}, {id: "org.ametys.plugins.admin.plugins.Deactivate", pluginName: "admin"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
/*
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.site.SiteActions.add","selection-target-type":"^(root-sites|site)$","label":"Nouveau site","description":"Crée un nouveau site","icon-small":"/plugins/web/resources/img/site/add_site_16.png","icon-medium":"/plugins/web/resources/img/site/add_site_32.png","icon-large":"/plugins/web/resources/img/site/add_site_48.png"}, {id: "org.ametys.web.admin.site.Add", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);

   control = Ext.create("Ametys.ribbon.element.ui.button.OpenToolButtonController", Ext.apply({"opentool-role":"uitool-groups","label":"Groupes d'utilisateurs","description":"Liste des groupes et de leurs utilisateurs","help":"org.ametys.core.groups","icon-small":"/plugins/core/resources/img/groups/group_16.png","icon-medium":"/plugins/core/resources/img/groups/group_32.png","icon-large":"/plugins/core/resources/img/groups/group_50.png"}, {id: "org.ametys.core.Groups", pluginName: "core"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
*/
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.admin.logs.LogsActions.download","selection-target-type":"^logfile$","label":"Télécharger","description":"Télécharger le ou les fichier(s) sélectionné(s)","icon-small":"/plugins/admin/resources/img/logs/download_16.png","icon-medium":"/plugins/admin/resources/img/logs/download_32.png","icon-large":"/plugins/admin/resources/img/logs/download_48.png"}, {id: "org.ametys.plugins.admin.logs.Download", pluginName: "admin"}));
   Ametys.ribbon.RibbonManager.registerElement(control);

   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.admin.logs.LogsActions.deleteFile","selection-target-type":"^logfile$","label":"Supprimer","description":"Supprimer le(s) fichier(s) sélectionnés","icon-small":"/plugins/admin/resources/img/logs/delete_16.png","icon-medium":"/plugins/admin/resources/img/logs/delete_32.png","icon-large":"/plugins/admin/resources/img/logs/delete_48.png"}, {id: "org.ametys.plugins.admin.logs.Delete", pluginName: "admin"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
/*
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.skin.SkinActions.configure","selection-target-type":"^skin$","label":"Configurer","description":"Modifie la configuration de la charte graphique.","icon-small":"/plugins/web/resources/img/administrator/skins/configure_16.png","icon-medium":"/plugins/web/resources/img/administrator/skins/configure_32.png","icon-large":"/plugins/web/resources/img/administrator/skins/configure_48.png"}, {id: "org.ametys.web.admin.skin.configure", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
*/
   control = Ext.create("Ametys.ribbon.element.ui.button.OpenToolButtonController", Ext.apply({"opentool-role":"uitool-admin-systemproperties","label":"Propriétés","description":"Cet outil vous permet de visualiser les propriétés système de lancement de la machine virtuelle java.","icon-small":"/plugins/admin/resources/img/jvmstatus/properties_16.png","icon-medium":"/plugins/admin/resources/img/jvmstatus/properties_32.png","icon-large":"/plugins/admin/resources/img/jvmstatus/properties_48.png"}, {id: "org.ametys.plugins.admin.SystemProperties", pluginName: "admin"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
/*
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.skin.SkinActions.export","selection-target-type":"^skin$","label":"Exporter","description":"Exporter la charte au format ZIP","icon-small":"/plugins/web/resources/img/administrator/skins/export_16.png","icon-medium":"/plugins/web/resources/img/administrator/skins/export_32.png","icon-large":"/plugins/web/resources/img/administrator/skins/export_48.png"}, {id: "org.ametys.web.admin.skin.export", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
*/
...
/*
   ...
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.core.users.UsersActions.impersonate","label":"Prendre le contrôle","description":"Se connecter au CMS avec les identifiants de l'utilisateur sélectionné.","selection-target-type":"^user$","selection-enable-multiselection":"false","selection-description-multiselectionforbidden":"Plusieurs utilisateurs sont actuellement sélectionnés.<br/>Sélectionnez un seul utilisateur afin de pouvoir se connecter avec ses identifiants.","help":"org.ametys.core.users.rights","icon-small":"/plugins/core/resources/img/users/impersonate_16.png","icon-medium":"/plugins/core/resources/img/users/impersonate_32.png","icon-large":"/plugins/core/resources/img/users/impersonate_48.png"}, {id: "org.ametys.core.users.Impersonate", pluginName: "core"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
   ...
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.site.SiteActions.open","selection-target-type":"^(site)$","label":"Ouvrir dans le CMS","description":"Ouvre le site sélectionné dans l'espace de contribution CMS","icon-small":"/plugins/web/resources/img/site/open_16.png","icon-medium":"/plugins/web/resources/img/site/open_32.png","icon-large":"/plugins/web/resources/img/site/open_48.png"}, {id: "org.ametys.web.admin.site.Open", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);

   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.site.SiteActions.saveConfig","selection-target-type":"^(site)$","selection-subtarget-type":"^(site-configuration)$","label":"Sauvegarder","description":"Sauvegarder les modifications","icon-small":"/plugins/web/resources/img/site/config/save_16.png","icon-medium":"/plugins/web/resources/img/site/config/save_32.png","icon-large":"/plugins/web/resources/img/site/config/save_48.png"}, {id: "org.ametys.web.admin.site.SaveConfig", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);

   control = Ext.create("Ametys.ribbon.element.ui.button.OpenToolButtonController", Ext.apply({"opentool-role":"uitool-users","label":"Utilisateurs","description":"Gestion des utilisateurs de l'application<br/>Cet outil vous permet de créer, modifier, rechercher les utilisateurs.<br/>Attention ! La recherche ne renvoie que 100 résultats.","help":"org.ametys.core.users","icon-small":"/plugins/core/resources/img/users/user_16.png","icon-medium":"/plugins/core/resources/img/users/user_32.png","icon-large":"/plugins/core/resources/img/users/user_48.png"}, {id: "org.ametys.core.Users", pluginName: "core"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
   ...
   control = Ext.create("Ametys.ribbon.element.ui.button.OpenToolButtonController", Ext.apply({"opentool-role":"uitool-admin-skin","label":"Chartes graphiques","description":"Gestion des chartes graphiques","icon-small":"/plugins/web/resources/img/skin/skin_16.png","icon-medium":"/plugins/web/resources/img/skin/skin_32.png","icon-large":"/plugins/web/resources/img/skin/skin_48.png"}, {id: "org.ametys.web.skin.SkinTool", pluginName: "skinfactory"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
*/
   control = Ext.create("Ametys.plugins.admin.system.SystemAnnouncementController", Ext.apply({"opentool-role":"uitool-admin-system","label":"Accès","description":"Cet outil permet de mettre en place une annonce d'accueil pour les utilisateurs.","announcement-on-description":"L'annonce système d'accueil est actuellement activée.","announcement-off-description":"L'annonce système d'accueil est actuellement désactivée.","icon-small":"/plugins/admin/resources/img/system/announcement_16.png","icon-medium":"/plugins/admin/resources/img/system/announcement_32.png","icon-large":"/plugins/admin/resources/img/system/announcement_48.png","announcement-on-icon-small":"/plugins/admin/resources/img/system/announcement_on_16.png","announcement-on-icon-medium":"/plugins/admin/resources/img/system/announcement_on_32.png","announcement-on-icon-large":"/plugins/admin/resources/img/system/announcement_on_48.png","announcement-off-icon-small":"/plugins/admin/resources/img/system/announcement_off_16.png","announcement-off-icon-medium":"/plugins/admin/resources/img/system/announcement_off_32.png","announcement-off-icon-large":"/plugins/admin/resources/img/system/announcement_off_48.png","available":false}, {id: "org.ametys.plugins.admin.System", pluginName: "admin"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
/*
...
*/
   ...
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.admin.config.SaveConfigAction.save","tool-role":"uitool-admin-config","selection-target-type":"^configuration$","label":"Sauver et redémarrer","description":"Enregistre les valeurs du formulaire et rédemarre l'application.","icon-small":"/plugins/admin/resources/img/config/save_16.png","icon-medium":"/plugins/admin/resources/img/config/save_32.png","icon-large":"/plugins/admin/resources/img/config/save_48.png"}, {id: "org.ametys.plugins.admin.config.Save", pluginName: "admin"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
/*
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.skin.SkinActions.saveConfig","selection-target-type":"^(skin|skin-temp)$","selection-subtarget-type":"^(skin-configuration)$","label":"Sauvegarder","description":"Sauvegarder les modifications","icon-small":"/plugins/web/resources/img/skin/config/save_16.png","icon-medium":"/plugins/web/resources/img/skin/config/save_32.png","icon-large":"/plugins/web/resources/img/skin/config/save_48.png"}, {id: "org.ametys.web.admin.skin.SaveConfig", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
*/
   control = Ext.create("Ametys.ribbon.element.ui.button.OpenToolButtonController", Ext.apply({"opentool-role":"uitool-admin-workspaces","label":"Workspaces","description":"Ouvre un outil permettant de visualiser les workspaces sous forme d'un arbre.","icon-small":"/plugins/admin/resources/img/plugins/workspaces_16.png","icon-medium":"/plugins/admin/resources/img/plugins/workspaces_32.png","icon-large":"/plugins/admin/resources/img/plugins/workspaces_48.png"}, {id: "org.ametys.plugins.admin.Workspaces", pluginName: "admin"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
...
/*
   ...
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.site.SiteActions.unsaveConfig","selection-target-type":"^(site)$","selection-subtarget-type":"^(site-configuration)$","label":"Fermer sans sauver","description":"Annule les modifications","icon-small":"/plugins/web/resources/img/site/config/unsave_16.png","icon-medium":"/plugins/web/resources/img/site/config/unsave_32.png","icon-large":"/plugins/web/resources/img/site/config/unsave_48.png"}, {id: "org.ametys.web.admin.site.UnsaveConfig", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
*//*
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.core.profiles.ProfilesTool.save","disabled":"true","selection-target-type":"^profile$","selection-subtarget-type":"^form$","selection-subtarget-parameter":{"name":"isDirty","value":"true"},"label":"Sauvegarder","description":"Sauvegarder les modifications effectuées sur ce profil.","icon-small":"/plugins/core/resources/img/profiles/save_16.png","icon-medium":"/plugins/core/resources/img/profiles/save_32.png","icon-large":"/plugins/core/resources/img/profiles/save_48.png"}, {id: "org.ametys.core.profiles.SaveRights", pluginName: "core"}));
   Ametys.ribbon.RibbonManager.registerElement(control);

   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.core.profiles.ProfilesTool.discardChanges","disabled":"true","selection-target-type":"^profile$","selection-subtarget-type":"^form$","selection-subtarget-parameter":{"name":"isDirty","value":"true"},"label":"Annuler","description":"Annuler les modifications en cours du profil.","icon-small":"/plugins/core/resources/img/profiles/unsave_16.png","icon-medium":"/plugins/core/resources/img/profiles/unsave_32.png","icon-large":"/plugins/core/resources/img/profiles/unsave_48.png"}, {id: "org.ametys.core.profiles.Discard", pluginName: "core"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
*//*
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.site.SiteActions.remove","selection-target-type":"^(site)$","label":"Supprimer","description":"Supprime le site sélectionné","icon-small":"/plugins/web/resources/img/site/delete_site_16.png","icon-medium":"/plugins/web/resources/img/site/delete_site_32.png","icon-large":"/plugins/web/resources/img/site/delete_site_48.png"}, {id: "org.ametys.web.admin.site.Delete", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);

   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.site.SiteActions.statistics","selection-target-type":"^(site)$","label":"Statistiques du site","description":"Cet outil permet de visualiser les statistiques du site","icon-small":"/plugins/web/resources/img/site/statistics_16.png","icon-medium":"/plugins/web/resources/img/site/statistics_32.png","icon-large":"/plugins/web/resources/img/site/statistics_48.png"}, {id: "org.ametys.web.admin.site.Statistics", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
*//*
   control = Ext.create("Ametys.ribbon.element.ui.button.OpenToolButtonController", Ext.apply({"opentool-role":"uitool-profiles","label":"Profils de droits","description":"Gestion des profils de droits.<br/>Un profil est un ensemble de droits. Chaque utilisateur possède un profil qui permet de connaître la liste de ses droits.","help":"org.ametys.core.rights.profiles","icon-small":"/plugins/core/resources/img/profiles/profile_16.gif","icon-medium":"/plugins/core/resources/img/profiles/profile_32.gif","icon-large":"/plugins/core/resources/img/profiles/profile_50.gif"}, {id: "org.ametys.core.Profiles", pluginName: "core"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
*/
   ...
   Ametys.ribbon.RibbonManager.registerElement(control);
/*
   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.site.SiteActions.configure","selection-target-type":"^(site)$","label":"Configurer","description":"Modifie la configuration du site.<br/><br/>Naviguez en utilisant les onglets et modifiez les valeurs des paramètres.","icon-small":"/plugins/web/resources/img/site/configure_site_16.png","icon-medium":"/plugins/web/resources/img/site/configure_site_32.png","icon-large":"/plugins/web/resources/img/site/configure_site_48.png"}, {id: "org.ametys.web.admin.site.Configure", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);

   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.skin.SkinActions.delete","selection-target-type":"^skin$","label":"Supprimer","description":"Supprimer la charte sélectionnée","icon-small":"/plugins/web/resources/img/administrator/skins/delete_16.png","icon-medium":"/plugins/web/resources/img/administrator/skins/delete_32.png","icon-large":"/plugins/web/resources/img/administrator/skins/delete_48.png"}, {id: "org.ametys.web.admin.skin.delete", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);

   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.skinfactory.model.SkinModelActions.export","selection-target-type":"^skin-model$","label":"Exporter","description":"Exporte le modèle sélectionné au format ZIP","icon-small":"/plugins/skinfactory/resources/img/model/export_16.png","icon-medium":"/plugins/skinfactory/resources/img/model/export_32.png","icon-large":"/plugins/skinfactory/resources/img/model/export_48.png"}, {id: "org.ametys.skinfactory.admin.model.export", pluginName: "skinfactory"}));
   Ametys.ribbon.RibbonManager.registerElement(control);

   control = Ext.create("Ametys.ribbon.element.ui.ButtonController", Ext.apply({"action":"Ametys.plugins.web.site.SiteActions.buildLive","selection-target-type":"^(site)$","label":"Reconstruire le live du site","description":"Reconstruit le workspace live du site sélectionné (le site ne sera plus accessible le temps de cette reconstruction).","icon-small":"/plugins/web/resources/img/site/build_live_16.png","icon-medium":"/plugins/web/resources/img/site/build_live_32.png","icon-large":"/plugins/web/resources/img/site/build_live_48.png"}, {id: "org.ametys.web.admin.site.BuildLive", pluginName: "web"}));
   Ametys.ribbon.RibbonManager.registerElement(control);
*/
...
var fgp_1_1_medium = [];
var fgp_1_1_large = [];
fgp_1_1_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.plugins.admin.config.Open").addUI("large"));
...
var fgp_1_2_medium = [];
var fgp_1_2_large = [];
fgp_1_2_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.plugins.admin.System").addUI("large"));
fgp_1_2_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.plugins.admin.JVMStatus").addUI("large"));
fgp_1_2_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.plugins.admin.SystemProperties").addUI("large"));
fgp_1_2_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.plugins.admin.Monitoring").addUI("large"));
...
var fgp_1_3_medium = [];
var fgp_1_3_large = [];
fgp_1_3_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.plugins.admin.Logs").addUI("large"));
fgp_1_3_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.plugins.admin.LogsLevel").addUI("large"));
...
var fgp_1_4_medium = [];
var fgp_1_4_large = [];
fgp_1_4_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.plugins.admin.PluginsByFile").addUI("large"));
fgp_1_4_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.plugins.admin.PluginsByExtensionPoint").addUI("large"));
fgp_1_4_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.plugins.admin.Workspaces").addUI("large"));
...
var fgp_1_5_medium = [];
var fgp_1_5_large = [];
fgp_1_5_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.web.admin.Sites").addUI("large"));
fgp_1_5_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.plugins.repository.administrator.JCRRepository").addUI("large"));
fgp_1_5_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.web.skin.SkinTool").addUI("large"));
...
var fgp_1_6_medium = [];
var fgp_1_6_large = [];
fgp_1_6_medium.push(Ametys.ribbon.RibbonManager.getElement("org.ametys.cms.content.indexing.solr.admin.ReindexAllContents").addUI("large"));

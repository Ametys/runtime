--_separator_=$$$
DECLARE
    CURSOR tables is SELECT table_name FROM user_tables where table_name IN ('RIGHTS_PROFILE', 'RIGHTS_PROFILERIGHTS', 'RIGHTS_GROUPRIGHTS', 'RIGHTS_USERRIGHTS', 'GROUPS_USERS', 'GROUPS', 'USERS');
